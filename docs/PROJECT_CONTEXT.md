...
**Last verified**: 2026-07-16 against source code (M21 — Cross-Domain Correlation & Unified Investigation)
**Test baseline**: 4,554 collectible (3,851 non-integration + 703 integration; 2 pre-existing collection errors for boto3/ldap adapters), ruff clean, mypy clean
