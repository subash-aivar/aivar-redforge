...
**Last verified**: 2026-07-16 against source code (M22 Phase 1 — Threat Intelligence Foundation: ATT&CK/CVE Reference Data, post-review-fix pass)
**Test baseline**: 4,688 collectible (3,939 non-integration + 749 integration), ruff clean, mypy clean (1 pre-existing unrelated `maxminddb` stub gap). Migration head: `0035`.
