"""InMemoryInvestigationEvaluatorRegistry — the one concrete registry
this milestone implements (M44D §4). Structurally identical to
M44A/M44B/M44C's in-memory registries: keyed by `(rule_id, exact
...
class InMemoryInvestigationEvaluatorRegistry:
    def __init__(self) -> None:
        self._by_rule: dict[str, dict[SchemaVersion, IInvestigationEvaluator]] = {}
