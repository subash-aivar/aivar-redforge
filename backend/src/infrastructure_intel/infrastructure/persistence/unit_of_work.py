...
`IUnitOfWork`, mirroring `tool_intel.infrastructure.persistence.
...
from infrastructure_intel.infrastructure.persistence.repositories.pg_infrastructure_repository import (  # noqa: E501
...
class SqlAlchemyUnitOfWork(IUnitOfWork):
    ...
    async def __aenter__(self) -> SqlAlchemyUnitOfWork:
        ...
        self.infrastructure = PgInfrastructureRepository(self._session)
        return self
