...
mirroring `tool_intel.infrastructure.events.structlog_event_publisher`
exactly.

Honest limitation: best-effort structured logging only — not a durable
event bus, not a transactional outbox."""
...
class StructlogEventPublisher(IEventPublisher):
    def __init__(self) -> None:
        self._logger = structlog.get_logger("infrastructure_intel.events")
