...
from ai_agent_governance.application.exceptions import ApplicationForbiddenError
...
def is_admin(actor_roles: tuple[str, ...]) -> bool:
    return AIPostureRole.ADMIN.value in actor_roles
