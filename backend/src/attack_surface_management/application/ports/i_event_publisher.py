...
matching `risk_engine.application.ports.i_event_publisher.
IEventPublisher` precedent exactly. Publishes domain events after a
successful unit-of-work commit. No implementation lives in `src/` at
this milestone — only the contract."""
