"""InMemoryDetectionEvaluatorRegistry — the one concrete registry this
milestone implements (M44A §4). Structurally identical to M43D's
`InMemoryEventNormalizerRegistry`: keyed by `(rule_id, exact
...
class InMemoryDetectionEvaluatorRegistry:
    def __init__(self) -> None:
        self._by_rule: dict[str, dict[SchemaVersion, IDetectionEvaluator]] = {}
